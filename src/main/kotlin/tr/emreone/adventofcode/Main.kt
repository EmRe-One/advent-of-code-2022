...
class Solutions {
    ...
    fun solveDay14() {
        ...
        val solution1 = Day14.part1(input); logger.info { "Solution1: $solution1" }; 
        val solution2 = Day14.part2(input); logger.info { "Solution2: $solution2" }; 
    }
    fun solveDay15() {
    ...
    fun solveDay18() {
        ...
        val solution1 = Day18.part1(input); logger.info { "Solution1: $solution1" }; 
        val solution2 = Day18.part2(input); logger.info { "Solution2: $solution2" }; 
    }
// $1
