...
class Solutions {
    ...
    fun solveDay21() {
        val input = Resources.resourceAsList(fileName = "day21.txt")
    ...
    fun solveDay22() {
        val input = Resources.resourceAsText(fileName = "day22.txt")
    ...
    fun solveDay23() {
        val input = Resources.resourceAsList(fileName = "day23.txt")
    ...
    fun solveDay24() {
        val input = Resources.resourceAsList(fileName = "day24.txt")
    ...
    fun solveDay25() {
        val input = Resources.resourceAsList(fileName = "day25.txt")
